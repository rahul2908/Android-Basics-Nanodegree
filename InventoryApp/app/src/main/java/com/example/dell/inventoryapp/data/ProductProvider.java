...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String mfgDate = values.getAsString(ProductEntry.COLUMN_PRODUCT_MFG_DATE);
        if (mfgDate == null){
            throw new IllegalArgumentException("Product requires a Manafacturing Date");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_MFG_DATE)){
            String mfgDate = values.getAsString(ProductEntry.COLUMN_PRODUCT_MFG_DATE);
            if (mfgDate == null){
                throw new IllegalArgumentException("It requires a valid mfgdate");
            }
        }
